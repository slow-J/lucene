 ...
 *       <p>When the postings are long enough, LuceneTestPostingsFormat will try to encode most
 ...
 *             DocFreq is not smaller than SkipMinimum (i.e. 128 in LuceneTestPostingsFormat).
 ...
 *             However, in LuceneTestPostingsFormat, the skip data is saved for
 ...
 * @lucene.experimental
 */
public final class LuceneTestPostingsFormat extends PostingsFormat {
  ...
  static final String TERMS_CODEC = "LuceneTestPostingsWriterTerms";
  static final String DOC_CODEC = "LuceneTestPostingsWriterDoc";
  static final String POS_CODEC = "LuceneTestPostingsWriterPos";
  static final String PAY_CODEC = "LuceneTestPostingsWriterPay";
  ...
  /** Creates {@code LuceneTestPostingsFormat} with default settings. */
  public LuceneTestPostingsFormat() {
    this(
  ...
  /**
   * Creates {@code LuceneTestPostingsFormat} with custom values for {@code minBlockSize} and {@code
   * maxBlockSize} passed to block terms dictionary.
   *
   * @see
   *     Lucene90BlockTreeTermsWriter#Lucene90BlockTreeTermsWriter(SegmentWriteState,PostingsWriterBase,int,int)
   */
  public LuceneTestPostingsFormat(int minTermBlockSize, int maxTermBlockSize) {
    super("LuceneTest");
  ...
  public FieldsConsumer fieldsConsumer(SegmentWriteState state) throws IOException {
    PostingsWriterBase postingsWriter = new LuceneTestPostingsWriter(state);
  ...
  public FieldsProducer fieldsProducer(SegmentReadState state) throws IOException {
    PostingsReaderBase postingsReader = new LuceneTestPostingsReader(state);
    boolean success = false;
    try {
  ...
  /**
   * Holds all state required for {@link LuceneTestPostingsReader} to produce a {@link
