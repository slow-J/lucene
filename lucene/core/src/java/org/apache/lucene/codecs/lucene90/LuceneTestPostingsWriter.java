 ...
 * @lucene.experimental
 */
public final class LuceneTestPostingsWriter extends PushPostingsWriterBase {
  ...
  public LuceneTestPostingsWriter(SegmentWriteState state) throws IOException {
...
//    TODO!!!!!!!!!!!!!!!!!!!!!!!!!!!
    if (docID < 0 || (docCount > 0 && docDelta <= 0)) {
      System.out.println("Uhhh!!!!!!! docs out of order (" + docID + " <= " + lastDocID + " )");
//      return;
